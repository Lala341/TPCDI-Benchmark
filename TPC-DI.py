...
def create_gcs_client():
    credentials_dict = {
      ...
      "private_key_id": "d564ef3e5c2ccdc91551e3f3baac567b8b8abb2f",
      "private_key": "-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----\n",
...
def load_finwire_files(dbname, scale_factor):
    ...
    for i, finwire in enumerate(sorted(finwire_files)):
        if i == 0:
            cmp, sec, fin = load_finwire_file(f"gs://{bucket_name}/{finwire}", "test")
        else:
